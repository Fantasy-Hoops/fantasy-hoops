...
export class Notifications extends Component {
  ...
  async componentDidMount() {
    ...
    await fetch(`http://fantasyhoops.org:5001/api/notification/${user.id}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async readAll(e) {
    e.preventDefault();
    await fetch(`http://fantasyhoops.org:5001/api/notification/readall/${user.id}`, {
      method: 'POST',
      headers: {
        'Content-type': 'application/json'
      }
    ...
    fetch(`http://fantasyhoops.org:5001/api/notification/${user.id}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
