...
export class Notifications extends Component {
  ...
  async componentDidMount() {
    ...
    await fetch(`http://localhost:44307/api/notification/${user.id}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async readAll() {
    await fetch(`http://localhost:44307/api/notification/readall/${user.id}`, {
      method: 'POST',
      headers: {
        'Content-type': 'application/json'
      }
    ...
    fetch(`http://localhost:44307/api/notification/${user.id}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
