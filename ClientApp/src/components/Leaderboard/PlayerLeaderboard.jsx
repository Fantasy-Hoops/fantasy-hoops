...
export class PlayerLeaderboard extends Component {
  ...
  async componentWillMount() {
    await fetch(`http://localhost:44307/api/leaderboard/player?type=daily`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/player?type=weekly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/player?type=monthly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async showModal(player) {
    ...
    await fetch(`http://localhost:44307/api/stats/${player.nbaID}`)
      .then(res => res.json())
      .then(res => {
        this.setState({
          stats: res,
  ...
  async loadDaily() {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/player?type=daily&from=${this.state.dailyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadWeekly() {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/player?type=weekly&from=${this.state.weeklyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadMonthly() {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/player?type=monthly&from=${this.state.monthlyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
