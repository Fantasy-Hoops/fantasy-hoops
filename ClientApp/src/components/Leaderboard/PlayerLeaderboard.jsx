...
export class PlayerLeaderboard extends Component {
  ...
  async componentWillMount() {
    await fetch(`https://localhost:5001/api/leaderboard/player?type=daily`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`https://localhost:5001/api/leaderboard/player?type=weekly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`https://localhost:5001/api/leaderboard/player?type=monthly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async showModal(player) {
    ...
    await fetch(`https://localhost:5001/api/stats/${player.nbaID}`)
      .then(res => res.json())
      .then(res => {
        this.setState({
          stats: res,
  ...
  async loadDaily() {
    ...
    await fetch(`https://localhost:5001/api/leaderboard/player?type=daily&from=${this.state.dailyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadWeekly() {
    ...
    await fetch(`https://localhost:5001/api/leaderboard/player?type=weekly&from=${this.state.weeklyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadMonthly() {
    ...
    await fetch(`https://localhost:5001/api/leaderboard/player?type=monthly&from=${this.state.monthlyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
