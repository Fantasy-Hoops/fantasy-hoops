...
export class PlayerLeaderboard extends Component {
  ...
  async componentWillMount() {
    await fetch(`http://fantasyhoops.org:5001/api/leaderboard/player?type=daily`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://fantasyhoops.org:5001/api/leaderboard/player?type=weekly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://fantasyhoops.org:5001/api/leaderboard/player?type=monthly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadDaily() {
    ...
    await fetch(`http://fantasyhoops.org:5001/api/leaderboard/player?type=daily&from=${this.state.dailyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadWeekly() {
    ...
    await fetch(`http://fantasyhoops.org:5001/api/leaderboard/player?type=weekly&from=${this.state.weeklyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadMonthly() {
    ...
    await fetch(`http://fantasyhoops.org:5001/api/leaderboard/player?type=monthly&from=${this.state.monthlyPlayers.length}&limit=${LOAD_COUNT}`)
      .then(res => {
        return res.json()
      })
      .then(res => {
