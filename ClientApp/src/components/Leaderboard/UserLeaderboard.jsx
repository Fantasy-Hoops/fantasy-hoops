...
export class UserLeaderboard extends Component {
  ...
  async componentWillMount() {
    await fetch(`http://localhost:44307/api/leaderboard/user?type=daily`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/user?type=weekly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/user?type=monthly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/user/${user.id}?type=daily`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/user/${user.id}?type=weekly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
    ...
    await fetch(`http://localhost:44307/api/leaderboard/user/${user.id}?type=monthly`)
      .then(res => {
        return res.json()
      })
      .then(res => {
  ...
  async loadDaily() {
    ...
    const link = this.state.friendsOnly
      ? `http://localhost:44307/api/leaderboard/user/${user.id}?type=daily&from=${this.state.friendsDailyUsers.length}&limit=${LOAD_COUNT}`
      : `http://localhost:44307/api/leaderboard/user?type=daily&from=${this.state.dailyUsers.length}&limit=${LOAD_COUNT}`;
    await fetch(link)
      .then(res => {
        return res.json()
      })
  ...
  async loadWeekly() {
    ...
    const link = this.state.friendsOnly
      ? `http://localhost:44307/api/leaderboard/user/${user.id}?type=weekly&from=${this.state.friendsWeeklyUsers.length}&limit=${LOAD_COUNT}`
      : `http://localhost:44307/api/leaderboard/user?type=weekly&from=${this.state.weeklyUsers.length}&limit=${LOAD_COUNT}`;
    await fetch(link)
      .then(res => {
        return res.json()
      })
  ...
  async loadMonthly() {
    ...
    const link = this.state.friendsOnly
      ? `http://localhost:44307/api/leaderboard/user/${user.id}?type=monthly&from=${this.state.friendsMonthlyUsers.length}&limit=${LOAD_COUNT}`
      : `http://localhost:44307/api/leaderboard/user?type=monthly&from=${this.state.monthlyUsers.length}&limit=${LOAD_COUNT}`;
    await fetch(link)
      .then(res => {
        return res.json()
      })
