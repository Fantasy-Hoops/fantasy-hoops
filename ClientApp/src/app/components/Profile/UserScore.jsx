...
export class UserScore extends PureComponent {
    render() {
        ...
        return (
            <div className={`UserScoreCard card bg-white rounded ${this.props.className}`}
                 style={{width: `${this.props.width}`, margin: `${this.props.center}`, marginBottom: '0.5rem'}}>
                <div className="UserScoreCard__body card-body">
                    ...
                    <div className="UserScoreCard__body-item UserScoreCard__result">
                        ...
                        {!this.props.activity.shortdate ?
                            <div className="UserScoreCard__date">{this.props.activity.shortDate}</div> : null}
                    </div>
                </div>
            </div>
        );
