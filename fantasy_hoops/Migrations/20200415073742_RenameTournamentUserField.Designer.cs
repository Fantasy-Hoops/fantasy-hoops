...
namespace fantasy_hoops.Migrations
{
    ...
    [Migration("20200415073742_RenameTournamentUserField")]
    partial class RenameTournamentUserField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Season", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("AllStarBreakGames")
                        .HasColumnType("int");

                    b.Property<DateTime>("EndDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("PlayoffGames")
                        .HasColumnType("int");

                    b.Property<int>("PreSeasonGames")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Tournaments.Contest", b =>
                {
                    ...
                    b.Property<string>("DroppedUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Tournaments.MatchupPair", b =>
                {
                    ...
                    b.HasKey("TournamentID", "FirstUserID", "SecondUserID", "ContestId");
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Tournaments.TournamentInvite", b =>
                {
                    ...
                    b.ToTable("TournamentInvites");
                });

            modelBuilder.Entity("fantasy_hoops.Models.Tournaments.TournamentUser", b =>
                {
                    b.Property<string>("TournamentID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Notifications.RequestNotification", b =>
                {
                    b.HasBaseType("fantasy_hoops.Models.Notification");
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Game", b =>
                {
                    ...
                    b.HasOne("fantasy_hoops.Models.Season", null)
                        .WithMany("Games")
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Tournaments.Contest", b =>
                {
                    b.HasOne("fantasy_hoops.Models.User", "DroppedUser")
                        .WithMany()
                        .HasForeignKey("DroppedUserId");

                    b.HasOne("fantasy_hoops.Models.Tournaments.Tournament", null)
                        .WithMany("Contests")
            ...
            modelBuilder.Entity("fantasy_hoops.Models.Tournaments.TournamentInvite", b =>
                {
                    b.HasOne("fantasy_hoops.Models.User", "InvitedUser")
                        .WithMany()
