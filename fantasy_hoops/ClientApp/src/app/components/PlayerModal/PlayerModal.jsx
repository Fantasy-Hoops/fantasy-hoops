...
export class PlayerModal extends Component {
                ...
                <div>
                    ...
                    <nav>
                        <div className="nav nav-pills mb-3" id="nav-tab" role="tablist">
                            ...
                            <a className="nav-item nav-link tab-no-outline" id="nav-charts-tab" data-toggle="tab"
                               href="#nav-charts" role="tab" aria-controls="nav-charts" aria-selected="false">Charts</a>
                        </div>
                    </nav>
    ...
    render() {
        return (
            <div className="modal fade" id="playerModal" tabIndex="-1" role="dialog" aria-labelledby="playerModalLabel"
                 aria-hidden="true">
