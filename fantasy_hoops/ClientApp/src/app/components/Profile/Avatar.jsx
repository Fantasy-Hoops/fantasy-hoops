    ...
    render() {
        ...
        return (
            <div>
                ...
                {!readOnly && isAdmin() && (
                    <div className="row">
                        <Link className="mx-auto" to={Routes.ADMIN}>
                            <Button>
                                <SupervisedUserCircleIcon fontSize="small"/>Admin panel
                            </Button>
                        </Link>
                    </div>
                )}
                ...
                && (
                    <div className="row">
                        <button type="button" className="btn btn-outline-primary mx-auto" data-toggle="modal"
