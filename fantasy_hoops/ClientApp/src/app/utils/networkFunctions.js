...
export const getTournamentById = tournamentId => axios.get(`${tournamentsApiUrlBase}/${tournamentId}`);
export const getTournamentDetails = (tournamentId, parameters) => axios.get(`${tournamentsApiUrlBase}/${tournamentId}/details${createParameters(parameters)}`);
...
export const startTournament = tournamentId => axios.get(`${tournamentsApiUrlBase}/start-tournament/${tournamentId}`);
export const simulateTournament = tournamentId => axios.get(`${tournamentsApiUrlBase}/simulate-tournament/${tournamentId}`);
